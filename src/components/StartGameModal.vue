    ...
    <div class="modal-overlay">
        <div class="modal glass-panel">
            ...
            <div class="mode-switch">
                <button class="glass-button" :class="{ active: mode === 'online' }" @click="mode = 'online'">
                    Онлайн
                </button>
                <button class="glass-button" :class="{ active: mode === 'bot' }" @click="mode = 'bot'">
                    С ботом
                </button>
            </div>
            ...
            <div v-if="mode === 'online'" class="section">
                <div class="preset-grid">
                    <button v-for="preset in presets" :key="preset.label" class="glass-button preset-card" :class="{
                        active: activePreset === preset.label,
                        disabled: isSearching && activePreset !== preset.label
                    }" :disabled="isSearching && activePreset !== preset.label" @click="selectPreset(preset)">
            ...
            <div v-else class="section">
                ...
                <div class="control">
                    ...
                    <input type="range" min="1" max="60" v-model="time" class="glass-range" />
                </div>
                ...
                <div class="color-select">
                    <div class="glass-button color-piece" :class="{ active: color === 'white' }"
                        @click="color = 'white'">
                        ♙
                    </div>
                    <div class="glass-button color-piece black" :class="{ active: color === 'black' }"
                        @click="color = 'black'">
                        ♟
                    </div>
                </div>
